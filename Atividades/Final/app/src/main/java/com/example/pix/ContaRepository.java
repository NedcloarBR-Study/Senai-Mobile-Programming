...
public class ContaRepository extends SQLiteOpenHelper {
    ...
    public void depositar(String valor) {
        String sql = "UPDATE contas SET saldo = saldo + ? WHERE id = 1";
    ...
    public Double getSaldo() {
        String sql = "SELECT saldo FROM contas WHERE id = 1";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String sqlCreateTable = "CREATE TABLE contas (" +
                "id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT," +
                "saldo REAL NOT NULL DEFAULT 0" +
                ")";
        sqLiteDatabase.execSQL(sqlCreateTable);
        String sqlCreateConta = "INSERT INTO contas (saldo) VALUES (0)";
